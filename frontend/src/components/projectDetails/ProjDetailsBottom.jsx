...
// import './projDetails.css';
// import { useDispatch, useSelector } from 'react-redux';
// import { fetchSingleBug, fetchSingleProject, openBugForm, openBugFormSuc, openBugSuccess, updateBug } from '../../redux';
...
//     console.log(tickets);
//     const [ticketAll, setTickets] = useState(tickets);
//     console.log('STATE', ticketAll)
//     const dispatch = useDispatch();
//     function onDropItem(event, str) {
//         event.preventDefault();
//         var data = event.dataTransfer.getData("text/plain");
...
//         dispatch(updateBug(data, newTicket));
//         // console.log(newTicket.projectId)
//         // dispatch(fetchSingleProject(newTicket.projectId))
//     }



//     let todo = ticketAll.filter((item) => item.status == 'OPEN');
//     let inprogress = ticketAll.filter((item) => item.status == 'INPROGRESS');
//     let completed = ticketAll.filter((item) => item.status == 'CLOSED')
